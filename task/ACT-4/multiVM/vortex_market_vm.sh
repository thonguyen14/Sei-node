...
rm -rf $HOME/SEI_ACT4_2/market_tx.json;
...
sei2d tx sign $HOME/SEI_ACT4_2/gen_market_tx.json -s $seq_2 -a $ACC_2 --offline --from $wallet_2 --chain-id atlantic-1 --home $HOME/.sei2 --output-document $HOME/SEI_ACT4_2/market_tx.json --node https://sei-testnet-rpc.polkachu.com:443; sleep 10;

#date -R >> $HOME/SEI_ACT4/txh.log
echo "Market order:" >> $HOME/SEI_ACT4_2/txh.log
sei2d tx broadcast $HOME/SEI_ACT4_2/market_tx.json --home $HOME/.sei2 --node https://sei-testnet-rpc.polkachu.com:443 | grep txhash >> $HOME/SEI_ACT4_2/txh.log
sleep 5;

echo "===========================================================" >> $HOME/SEI_ACT4_2/txh.log;
